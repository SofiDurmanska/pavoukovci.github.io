...
L:"ytp-mdx-popup-dialog",W:{role:"dialog"},U:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",U:[{G:"div",L:"ytp-mdx-popup-title",qa:"Jste odhl\u00e1\u0161eni"},{G:"div",L:"ytp-mdx-popup-description",qa:"Videa, kter\u00e1 sledujete, mohou b\u00fdt p\u0159id\u00e1na do historie sledov\u00e1n\u00ed televize a\u00a0ovlivnit doporu\u010den\u00ed pro televizi. Pokud si to nep\u0159ejete, akci zru\u0161te a\u00a0p\u0159ihlaste se na YouTube na po\u010d\u00edta\u010di."},{G:"div",L:"ytp-mdx-privacy-popup-buttons",
U:[{G:"button",Ha:["ytp-button","ytp-mdx-privacy-popup-cancel"],qa:"Zru\u0161it"},{G:"button",Ha:["ytp-button","ytp-mdx-privacy-popup-confirm"],qa:"Potvrdit"}]}]}]});this.j=new g.GJ(this,250);this.cancelButton=this.Da("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Da("ytp-mdx-privacy-popup-confirm");g.J(this,this.j);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},N9=function(a){g.V.call(this,{G:"div",
...
b=g.U(b,128)?g.tG("Chyba na za\u0159\u00edzen\u00ed $RECEIVER_NAME",c):b.Jc()||g.U(b,4)?g.tG("P\u0159ehr\u00e1v\u00e1n\u00ed na za\u0159\u00edzen\u00ed $RECEIVER_NAME",c):g.tG("P\u0159ipojeno k\u00a0za\u0159\u00edzen\u00ed $RECEIVER_NAME",c);a.Ma("statustext",b);a.j.show()}else a.j.hide()},O9=function(a,b){g.zP.call(this,"P\u0159ehr\u00e1t na",0,a,b);
...
break;case -1:this.hc(new g.ZH(64));break;case -1E3:this.hc(new g.ZH(128,{errorCode:"mdx.remoteerror",errorMessage:"Toto video nen\u00ed k dispozici pro vzd\u00e1len\u00e9 p\u0159ehr\u00e1v\u00e1n\u00ed.",SE:2}))}a=a9(this.dc).trackData;var b=this.C;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.C=a,K2a(this,a));a=a9(this.dc);-1===a.volume||Math.round(this.I.getVolume())===a.volume&&this.I.isMuted()===a.muted||this.X.isActive()||
this.tQ()}else J2a(this)};
...
O9.prototype.Bj=function(a){return"cast-selector-receiver"===a?"Vys\u00edl\u00e1n\u00ed\u2026":this.hp[a].name};
